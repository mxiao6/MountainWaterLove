...
namespace UnityEditor
{
    public class StandardShaderVCGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            // public static GUIContent startTime = new GUIContent("startTime", "startTime");
        ...
        MaterialProperty startTime = null;
        MaterialProperty disSpeed = null;
        MaterialProperty duration = null;
